 ...
 */
public class SaveGame extends MenuTemplate {

    private String[] options = {"Save", "Back to In Game Menu"};
    private int currentChoice = 0;
    private Color titleColor;
    private Font titleFont;
    private Font font;

    public SaveGame (MenuManager menuManager, GameStateManager gsm) {
